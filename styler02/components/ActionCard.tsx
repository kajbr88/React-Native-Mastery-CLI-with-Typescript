import {
    StyleSheet,
    Text, View, Linking, Image, TouchableOpacity, useColorScheme
} from 'react-native'
...
export default function ActionCard() {
    ...
    return (
        <View>
            <Text style={[styles.headingText, isDarkMode ? styles.whiteText : styles.darkText]}>Blog Card</Text>
...
const styles = StyleSheet.create({
    ...
    headingContainer: {
        height: 40,
        flexDirection: 'row',//flexDirection property provides below specified two properties.
